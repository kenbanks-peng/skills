...
3. Return board/card references, delivered changes, verification results (including failed or unrun checks), blockers, and remaining work with the next action. On interruption, return the same information as a handoff.
